    ...
    <b-container fluid>
        <b-tabs>
            <b-tab title="资源管理器">
                        ...
                        <b-card>
                            <table class="dm-table">
                                ...
                                <tr v-if="currentDMResource != null">
                                    ...
                                    <td>
                                        <strong>{{
                                            currentDMResource.MD5
                                        }}</strong>
                                    </td>
                                </tr>
                                <tr v-if="currentDMResource != null">
                                    <td>
                                        <small for="id-rating-sm-no-border"
                                            >评分</small
                                        >
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td v-if="currentDMResource != null">
                                        <div
                                            v-if="
                                                currentDMResource.BackupIdList !=
                                                    null
                                            "
                                        >
                                            <b-badge
                ...
                <pre v-if="currentDMResource != null">{{
                    currentDMResource
                }}</pre>
                ...
                <b-navbar fixed="bottom" toggleable="sm">
                    <b-nav class="mr-0">
                        <b-button
                            ...
                            >i</b-button
                        >
                        <b-badge v-if="isWsConn" variant="success"
                            >WS已连接</b-badge
                        >
    ...
    methods: {
        ...
        websocketinit() {
            try {
                this.websock = new WebSocket(
                    apiAddrWS + "/v1x1/dm/1/task/status/ws"
                );
        ...
        clickExplorer(record, index) {
            ...
            if (record.IsDir == true) {
                this.GetDirSize(this.currentDir + "/" + record.Name);
