 ...
 * @LastEditors: cyf
 * @LastEditTime: 2020-11-07 11:34:17
...
<template>
  <b-container>
    ...
    <p class="text-center mb-2">还没有账户？<b-badge variant="light" href="/account/signin">前往注册</b-badge></p>
    <div role="group" class="mb-2">
      <b-form-input id="input-login-login" v-model="login" :state="getType" placeholder="用户名/邮箱/手机" size="sm" trim></b-form-input>
      <small>{{loginTypeShowText}}</small>
    </div>
    <div role="group" class="mb-2">
      <b-form-input id="input-login-paswd" type="password" v-model="pswd" placeholder="密码" size="sm" trim></b-form-input>
    </div>
