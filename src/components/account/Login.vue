 ...
 * @LastEditors: cyf
 * @LastEditTime: 2021-08-09 20:26:48
...
<template>
    <b-container>
        <b-alert
            ...
            class="mt-3"
            dismissible
            >您访问的页面需要登录，请先登录。</b-alert
        >
        <b-card>
            <h2 class="text-center mt-3">账户登录</h2>
            <p class="text-center mb-2">
                还没有账户？<b-badge variant="light" href="/account/signin"
                    >前往注册</b-badge
                >
            </p>
            ...
            <b-form-checkbox switch class="ml-2" v-model="keepLogin"
                >保持登陆状态</b-form-checkbox
            >
            <small class="ml-2 my-2" style="color: gray;" v-if="!keepLogin"
                >当不保持登陆状态时，您关闭标签页后就会失去登陆状态。<br
            /></small>
            <br />
            <b-button
                block
...
import iddy from "../../cc/v1x1/Identity";
