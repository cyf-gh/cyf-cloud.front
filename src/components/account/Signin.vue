 ...
 * @LastEditors: cyf
 * @LastEditTime: 2020-11-19 15:34:19
        ...
        <b-card>
            ...
            <div class="text-center">
                <h4>
                    <b-badge
                        variant="primary"
                        target="blank"
                        href="http://se.cyf-cloud.cn:8228/auth/register"
            ...
            <div role="group">
                ...
                <b-form-invalid-feedback id="input-name-feedback"
                    >昵称至少三个字符</b-form-invalid-feedback
                >
            ...
            <div role="group">
                ...
                <b-form-invalid-feedback id="input-email-feedback"
                    >请输入正确的邮箱</b-form-invalid-feedback
                >
            ...
            <div role="group">
                ...
                <b-form-invalid-feedback id="input-phone-feedback"
                    >请输入正确的手机号码</b-form-invalid-feedback
                >
                <b-form-text id="input-phone-help"
                    >输入你的手机号码（可选项）</b-form-text
                >
            </div>
            <br />
            <div role="group">
                <b-form-input
                    ...
                    trim
                ></b-form-input>
                <b-form-invalid-feedback id="input-pswd-feedback"
                    >请输入至少六位的密码，且密码不能与用户名一致</b-form-invalid-feedback
                >
            ...
            <div role="group">
                <b-form-input
                    ...
                    trim
                ></b-form-input>
                <b-form-invalid-feedback id="input-pswdRp-feedback"
                    >请输入一致的密码</b-form-invalid-feedback
                >
                <b-form-text id="input-pswdRp-help"
                    >再次输入你的密码</b-form-text
                >
            </div>
            <br />
            <div role="group">
                ...
                <b-button v-on:click="getNewCap" variant="light"
                    >点击获取新验证码</b-button
                >
                <b-form-text id="input-cap-help" class="ml-3"
                    >请输入4位验证码</b-form-text
                >
            </div>
            <br />
            <b-button
                ...
                >{{ count }} 秒后跳转</b-button
            >
            <b-button block variant="light" v-else v-on:click="goRegister"
                >注册</b-button
            >
            <br />
        </b-card>
...
export default {
    methods: {
        ...
        goRegister() {
            if (
                ...
                this.axios
                    .post(apiSe + "/v1x1/account/register", this.rgst, {
    ...
    computed: {
        ...
        pswdState() {
            return (
                this.rgst.pswd.length >= 6 && this.rgst.pswd != this.rgst.name
            );
        },
        pswdRpState() {
